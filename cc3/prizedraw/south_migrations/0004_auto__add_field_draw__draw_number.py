...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Draw._draw_number'
        db.add_column(u'prizedraw_draw', '_draw_number',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Draw._draw_number'
        db.delete_column(u'prizedraw_draw', '_draw_number')
