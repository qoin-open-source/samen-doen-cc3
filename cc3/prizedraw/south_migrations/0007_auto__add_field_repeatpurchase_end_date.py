...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RepeatPurchase.end_date'
        db.add_column(u'prizedraw_repeatpurchase', 'end_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RepeatPurchase.end_date'
        db.delete_column(u'prizedraw_repeatpurchase', 'end_date')
