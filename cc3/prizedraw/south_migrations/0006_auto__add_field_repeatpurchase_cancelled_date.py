...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RepeatPurchase.cancelled_date'
        db.add_column(u'prizedraw_repeatpurchase', 'cancelled_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RepeatPurchase.cancelled_date'
        db.delete_column(u'prizedraw_repeatpurchase', 'cancelled_date')
