...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Ticket', fields ['draw', 'serial_number']
        db.create_unique(u'prizedraw_ticket', ['draw_id', 'serial_number'])


    def backwards(self, orm):
        # Removing unique constraint on 'Ticket', fields ['draw', 'serial_number']
        db.delete_unique(u'prizedraw_ticket', ['draw_id', 'serial_number'])
