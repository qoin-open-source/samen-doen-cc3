...
urlpatterns = patterns('',
    ...
    # registration form now in troeven_front.profile app
    #    url(r'^register/$',
    #        TroevenRegistrationView.as_view(),
    ...
    # manually include the auth_urls so that the password_reset can be left out
