...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SectionColumnNewsPlugin.num_entries'
        db.add_column(u'cmsplugin_sectioncolumnnewsplugin', 'num_entries',
                      self.gf('django.db.models.fields.IntegerField')(default=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SectionColumnNewsPlugin.num_entries'
        db.delete_column(u'cmsplugin_sectioncolumnnewsplugin', 'num_entries')
