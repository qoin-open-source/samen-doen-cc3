...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SocialMediaLink'
        db.create_table(u'cmscontent_socialmedialink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('social_plugin', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cmscontent.SocialMediaLinksPlugin'])),
            ('link_target', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('link_text', self.gf('django.db.models.fields.CharField')(max_length=130, blank=True)),
            ('css_icon_class', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
        ))
        db.send_create_signal(u'cmscontent', ['SocialMediaLink'])

        # Adding model 'SocialMediaLinksPlugin'
        db.create_table(u'cmsplugin_socialmedialinksplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='social media', max_length=75)),
        ))
        db.send_create_signal(u'cmscontent', ['SocialMediaLinksPlugin'])


    def backwards(self, orm):
        # Deleting model 'SocialMediaLink'
        db.delete_table(u'cmscontent_socialmedialink')

        # Deleting model 'SocialMediaLinksPlugin'
        db.delete_table(u'cmsplugin_socialmedialinksplugin')
