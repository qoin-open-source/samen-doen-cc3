...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cmsplugin_homepageblock', 'link', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'HomepageBlock.link'
        db.alter_column(u'cmsplugin_homepageblock', 'link', self.gf('django.db.models.fields.URLField')(max_length=200))
