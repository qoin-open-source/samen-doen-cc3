...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SectionColumnNoticePlugin'
        db.create_table(u'cmsplugin_sectioncolumnnoticeplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('paragraph_1', self.gf('django.db.models.fields.TextField')()),
            ('paragraph_2', self.gf('django.db.models.fields.TextField')()),
            ('link_target', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('link_text', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal(u'cmscontent', ['SectionColumnNoticePlugin'])


    def backwards(self, orm):
        # Deleting model 'SectionColumnNoticePlugin'
        db.delete_table(u'cmsplugin_sectioncolumnnoticeplugin')
