...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HomepageBlock.link'
        db.alter_column(u'cmsplugin_homepageblock', 'link', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

    def backwards(self, orm):

        # Changing field 'HomepageBlock.link'
        db.alter_column(u'cmsplugin_homepageblock', 'link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
