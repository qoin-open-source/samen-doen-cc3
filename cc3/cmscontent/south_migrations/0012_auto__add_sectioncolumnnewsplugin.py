...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SectionColumnNewsPlugin'
        db.create_table(u'cmsplugin_sectioncolumnnewsplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal(u'cmscontent', ['SectionColumnNewsPlugin'])


    def backwards(self, orm):
        # Deleting model 'SectionColumnNewsPlugin'
        db.delete_table(u'cmsplugin_sectioncolumnnewsplugin')
